...
describe('ContactStatus e2e test', () => {
    ...
    it('should load ContactStatuses', async () => {
        ...
        expect(await contactStatusComponentsPage.getTitle()).to.eq('cwcrmApp.contactStatus.home.title');
    });
    ...
    it('should load create ContactStatus page', async () => {
        ...
        expect(await contactStatusUpdatePage.getPageTitle()).to.eq('cwcrmApp.contactStatus.home.createOrEditLabel');
    ...
    it('should delete last ContactStatus', async () => {
        ...
        expect(await contactStatusDeleteDialog.getDialogTitle()).to.eq('cwcrmApp.contactStatus.delete.question');
