...
describe('ContactSubStatus e2e test', () => {
    ...
    it('should load ContactSubStatuses', async () => {
        ...
        expect(await contactSubStatusComponentsPage.getTitle()).to.eq('cwcrmApp.contactSubStatus.home.title');
    });
    ...
    it('should load create ContactSubStatus page', async () => {
        ...
        expect(await contactSubStatusUpdatePage.getPageTitle()).to.eq('cwcrmApp.contactSubStatus.home.createOrEditLabel');
    ...
    it('should create and save ContactSubStatuses', async () => {
        ...
        await contactSubStatusComponentsPage.clickOnCreateButton();
        await promise.all([contactSubStatusUpdatePage.setNameInput('name')]);
    ...
    it('should delete last ContactSubStatus', async () => {
        ...
        expect(await contactSubStatusDeleteDialog.getDialogTitle()).to.eq('cwcrmApp.contactSubStatus.delete.question');
