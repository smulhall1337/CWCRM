...
describe('ParticipantNotes e2e test', () => {
    ...
    it('should load ParticipantNotes', async () => {
        ...
        expect(await participantNotesComponentsPage.getTitle()).to.eq('cwcrmApp.participantNotes.home.title');
    });
    ...
    it('should load create ParticipantNotes page', async () => {
        ...
        expect(await participantNotesUpdatePage.getPageTitle()).to.eq('cwcrmApp.participantNotes.home.createOrEditLabel');
    ...
    it('should delete last ParticipantNotes', async () => {
        ...
        expect(await participantNotesDeleteDialog.getDialogTitle()).to.eq('cwcrmApp.participantNotes.delete.question');
