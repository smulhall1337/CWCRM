...
describe('ExtendedUser e2e test', () => {
    ...
    it('should load ExtendedUsers', async () => {
        ...
        expect(await extendedUserComponentsPage.getTitle()).to.eq('cwcrmApp.extendedUser.home.title');
    });
    ...
    it('should load create ExtendedUser page', async () => {
        ...
        expect(await extendedUserUpdatePage.getPageTitle()).to.eq('cwcrmApp.extendedUser.home.createOrEditLabel');
    ...
    it('should create and save ExtendedUsers', async () => {
        ...
        await extendedUserComponentsPage.clickOnCreateButton();
        await promise.all([
            extendedUserUpdatePage.departmentSelectLastOption(),
            extendedUserUpdatePage.employeeTypeSelectLastOption(),
            extendedUserUpdatePage.employeeSubTypeSelectLastOption(),
    ...
    it('should delete last ExtendedUser', async () => {
        ...
        expect(await extendedUserDeleteDialog.getDialogTitle()).to.eq('cwcrmApp.extendedUser.delete.question');
