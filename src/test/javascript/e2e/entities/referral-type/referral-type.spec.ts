...
describe('ReferralType e2e test', () => {
    ...
    it('should load ReferralTypes', async () => {
        ...
        expect(await referralTypeComponentsPage.getTitle()).to.eq('cwcrmApp.referralType.home.title');
    });
    ...
    it('should load create ReferralType page', async () => {
        ...
        expect(await referralTypeUpdatePage.getPageTitle()).to.eq('cwcrmApp.referralType.home.createOrEditLabel');
    ...
    it('should delete last ReferralType', async () => {
        ...
        expect(await referralTypeDeleteDialog.getDialogTitle()).to.eq('cwcrmApp.referralType.delete.question');
