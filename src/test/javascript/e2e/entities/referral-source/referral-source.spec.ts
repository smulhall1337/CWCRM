...
describe('ReferralSource e2e test', () => {
    ...
    it('should load ReferralSources', async () => {
        ...
        expect(await referralSourceComponentsPage.getTitle()).to.eq('cwcrmApp.referralSource.home.title');
    });
    ...
    it('should load create ReferralSource page', async () => {
        ...
        expect(await referralSourceUpdatePage.getPageTitle()).to.eq('cwcrmApp.referralSource.home.createOrEditLabel');
    ...
    it('should delete last ReferralSource', async () => {
        ...
        expect(await referralSourceDeleteDialog.getDialogTitle()).to.eq('cwcrmApp.referralSource.delete.question');
