...
public class ContactStatusResource {
    ...
    /**
     * SEARCH  /_search/contact-statuses?query=:query : search for the contactStatus corresponding
     * to the query.
     *
     * @param query the query of the contactStatus search
     * @return the result of the search
     */
    @GetMapping("/_search/contact-statuses")
    @Timed
    public List<ContactStatusDTO> searchContactStatuses(@RequestParam String query) {
        log.debug("REST request to search ContactStatuses for query {}", query);
        return contactStatusService.search(query);
    }
