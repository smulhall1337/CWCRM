...
public class WaiverResource {
    ...
    /**
     * SEARCH  /_search/waivers?query=:query : search for the waiver corresponding
     * to the query.
     *
     * @param query the query of the waiver search
     * @return the result of the search
     */
    @GetMapping("/_search/waivers")
    @Timed
    public List<WaiverDTO> searchWaivers(@RequestParam String query) {
        log.debug("REST request to search Waivers for query {}", query);
        return waiverService.search(query);
    }
