...
public class ParticipantNotesResource {
    ...
    /**
     * SEARCH  /_search/participant-notes?query=:query : search for the participantNotes corresponding
     * to the query.
     *
     * @param query the query of the participantNotes search
     * @return the result of the search
     */
    @GetMapping("/_search/participant-notes")
    @Timed
    public List<ParticipantNotesDTO> searchParticipantNotes(@RequestParam String query) {
        log.debug("REST request to search ParticipantNotes for query {}", query);
        return participantNotesService.search(query);
    }
