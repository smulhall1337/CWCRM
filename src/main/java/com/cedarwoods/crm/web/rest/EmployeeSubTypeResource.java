...
public class EmployeeSubTypeResource {
    ...
    /**
     * SEARCH  /_search/employee-sub-types?query=:query : search for the employeeSubType corresponding
     * to the query.
     *
     * @param query the query of the employeeSubType search
     * @return the result of the search
     */
    @GetMapping("/_search/employee-sub-types")
    @Timed
    public List<EmployeeSubTypeDTO> searchEmployeeSubTypes(@RequestParam String query) {
        log.debug("REST request to search EmployeeSubTypes for query {}", query);
        return employeeSubTypeService.search(query);
    }
