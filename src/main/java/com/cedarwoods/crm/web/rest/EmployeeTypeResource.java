...
public class EmployeeTypeResource {
    ...
    @Timed
    public List<EmployeeTypeDTO> searchEmployeeTypes(@RequestParam String query) {
        log.debug("REST request to search EmployeeTypes for query {}", query);
        return employeeTypeService.search(query);
    }
