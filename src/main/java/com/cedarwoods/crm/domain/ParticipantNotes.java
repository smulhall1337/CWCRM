...
@Document(indexName = "participantnotes")
public class ParticipantNotes extends AbstractAuditingEntity implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("participantNotes")
